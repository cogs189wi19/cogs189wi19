% Alright the dudes who published this chose a whack ass format
%
...
for s = ses
    for r = run
        ...
        % We can do this in two passes by finding all 0 indices, and all locations
        % where the index after a 0 is not 0
